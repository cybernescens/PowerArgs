    ...
    protected override float RunActual(ConsoleApp app)
    {
        ...
        app.Invoke(
            (Func<Task>)(async () => {
                ...
                var nLabel = app.LayoutRoot.Add(new Label { ZIndex = 100, Text = $"N = {n}".ToCyan() })
                ...
                var colliderGroup = new ColliderGroup(app, app);
                ...
                while (true)
                {
                    ...
                    {
                        el.Bounds = new RectF(
                            random.Next(0, app.LayoutRoot.Width - 2),
                            random.Next(0, app.LayoutRoot.Height - 1),
                            el.Width,
                            el.Height);
                    }
