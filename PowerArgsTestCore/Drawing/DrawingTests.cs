    ...
    public void DrawLines()
    {
        ...
        app.InvokeNextCycle(
            async () => {
                ...
                bitmap.DrawLine(
                    new ConsoleCharacter('X', ConsoleColor.Magenta),
                    centerX,
                    centerY,
                    (int)(bitmap.Width * .75),
                    0);
                ...
                bitmap.DrawLine(
                    new ConsoleCharacter('X', ConsoleColor.Gray),
                    centerX,
                    centerY,
                    bitmap.Width - 1,
                    centerY / 2);
                ...
                bitmap.DrawLine(
                    new ConsoleCharacter('X', ConsoleColor.Blue),
                    centerX,
                    centerY,
                    bitmap.Width - 1,
                    bitmap.Height / 2);
                ...
                bitmap.DrawLine(
                    new ConsoleCharacter('X', ConsoleColor.Yellow),
                    centerX,
                    centerY,
                    centerX / 2,
                    bitmap.Height - 1);
                ...
                bitmap.DrawLine(
                    new ConsoleCharacter('X', ConsoleColor.Green),
                    centerX,
                    centerY,
                    centerX,
                    bitmap.Height - 1);
                ...
                bitmap.DrawLine(
                    new ConsoleCharacter('X', ConsoleColor.Cyan),
                    centerX,
                    centerY,
                    bitmap.Width - 1,
                    bitmap.Height - 1);
