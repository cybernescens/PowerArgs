...
/// <summary>
///     Used for internal implementation, but marked public for testing, please do not use.  This is basically a wrapper
///     around the system console.
/// </summary>
public class StdConsoleProvider : IConsoleProvider
{
    private const int STD_OUTPUT_HANDLE = -11;

    private static readonly Dictionary<char, ConsoleKeyInfo> KeyMap = CreateKeyMap();
    ...
    public void Write(char[] buffer, int length) { Console.Write(buffer, 0, length); }
    ...
    public static string ReadALineOfConsoleOutput(int y)
    {
        ...
        var nLength = Console.WindowWidth;
        var lpCharacter = new StringBuilder(nLength);
    ...
    {
        var ret = new Dictionary<char, ConsoleKeyInfo>();
