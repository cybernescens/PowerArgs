...
public class PauseManager
{
    ...
    public PauseManager(ConsoleApp application)
    {
    ...
    public Event<ILifetimeManager> OnPaused { get; } = new();
...
{
    private readonly PauseManager manager;
    ...
    {
        Task conditionTask = manager.Application.InvokeAsync(
            async () => {
