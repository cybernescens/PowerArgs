...
{
    private readonly ConsolePanel? container;
    ...
    public BorderPanel(ConsoleControl? content)
    {
        ...
        SubscribeForLifetime(this, nameof(Background), () => container.Background = Background);
    }

    /// <summary>
    ///     Set this to override the border color. By default the panel will try to find a dark version of your content's
    ///     background color.
    /// </summary>
    ...
    public ConsoleString? Adornment
    {
        get => Get<ConsoleString>();
        set => Set(value);
    }
