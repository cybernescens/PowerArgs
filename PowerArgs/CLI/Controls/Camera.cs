...
public class Camera : ConsolePanel
{
    ...
    public LocF CameraLocation
    {
        ...
        set {
            ...
            {
                if (BigBounds.Width < Width || BigBounds.Height < Height)
                    throw new NotSupportedException("BigBounds too small");
    ...
    public Task AnimateBy(
        float dx,
        float dy,
        float duration = 1000,
        EasingFunction ease = null,
        ILifetimeManager lt = null) =>
    ...
    public void EnableKeyboardPanning(ILifetimeManager? lt = null, bool wasd = true, bool arrows = true)
    {
        ...
        var keys = Application.FocusManager.GlobalKeyHandlers;
